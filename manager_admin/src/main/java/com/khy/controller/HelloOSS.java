...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIBHCNeY6xhOlS";
    private static String accessKeySecret = "00cd2etgTUe6rD4bQXGQv3uZzUJzAA";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "nongke";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ossClient.putObject(bucketName, "test1/khy11.jpg", new File("d:/1111.jpg"));
            ossClient.shutdown();
